...
public boolean EliminarCurso(int idCurso){
   ...
   public TableModel ListarCursoProf(int id){
        DefaultTableModel modelo = new DefaultTableModel();
        try {
             //Para ejecutar la consulta
             operaciones consulta=new operaciones(); //crea un objeto de la clase consulta
             ResultSet resultado=consulta.ConsultaBase("select c.Idcurso,c.Nombrecurso,p.Idprofesor,p.Nombres,p.Apellidos from curso c,profesor p where c.Idprofesor=p.Idprofesor and p.Idprofesor = '"+id+"'"); //
